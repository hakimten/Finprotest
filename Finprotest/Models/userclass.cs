...
namespace Finprotest.Models
{
    public class userclass
    {
        ...
        public int Cart_kuantity { get; internal set; }
        public int total_harga { get; internal set; }
        public string cart_status { get; internal set; }
        public string VALIDASI { get; internal set; }
        ...
        public string name_buyer { get; internal set; }
        public int almt_Id { get; internal set; }
        public int zip_code { get; internal set; }
        public int prov_id { get; internal set; }
